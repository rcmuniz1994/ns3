...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_netanim__NetAnim_t, stringdata) + ofs \
...
const QMetaObject netanim::NetAnim::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_netanim__NetAnim.data,
      qt_meta_data_netanim__NetAnim,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_netanim__NetAnim.stringdata))
