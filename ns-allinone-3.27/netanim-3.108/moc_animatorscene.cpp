...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_netanim__AnimatorScene_t, stringdata) + ofs \
...
const QMetaObject netanim::AnimatorScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_netanim__AnimatorScene.data,
      qt_meta_data_netanim__AnimatorScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_netanim__AnimatorScene.stringdata))
