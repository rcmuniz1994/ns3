...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_netanim__AnimPropertyBroswer_t, stringdata) + ofs \
...
const QMetaObject netanim::AnimPropertyBroswer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_netanim__AnimPropertyBroswer.data,
      qt_meta_data_netanim__AnimPropertyBroswer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_netanim__AnimPropertyBroswer.stringdata))
